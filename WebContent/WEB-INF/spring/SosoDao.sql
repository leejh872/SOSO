...
select * from [user];
--제약조건 때문에 userrole 에서 먼저 삭제하고 user에서 삭제 해야함
DELETE [user] WHERE EMAIL = 'zmfpdlwl0909@naver.co'
DELETE USERROLE WHERE USERID = 'zmfpdlwl0909@naver.co';

INSERT INTO USERROLE VALUES('ROLE_ADMIN','leejh872@naver.com', '1');
INSERT INTO USERROLE VALUES('ROLE_USER','totolo@naver.com', '1');
UPDATE USERROLE SET DEFAULTROLE=1 WHERE USERID = 'leejh872@naver.com' AND ROLENAME='ROLE_ADMIN';
UPDATE USERROLE SET DEFAULTROLE=1 WHERE USERID = 'leejh872@naver.com' AND ROLENAME='ROLE_USER';